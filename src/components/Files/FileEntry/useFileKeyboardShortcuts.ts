...
import { Files, FolderActions } from "./useFolder";
import { useProcesses } from "@/contexts/process";
import useTransferDialog from "../../Dialogs/Transfer/useTransferDiaglog";
import { useSession } from "@/contexts/session";
import { useCallback, useEffect } from "react";
import { DESKTOP_PATH, PREVENT_SCROLL } from "@/lib/constants";
import { createFileReaders } from "../FileManager/functions";
import { haltEvent, sendMouseClick } from "@/lib/utils";

!(function (t, e) {
  ...
  (() => {
    ...
    h.VantaBase = class {
        ...
        if (
          ...
          if (((this.el = this.options.el), null == this.el))
            ...
            if (((this.el = ((i = t), document.querySelector(i))), !this.el))
              return void r("Cannot find element", t);
          }
          this.prepareEl();
        }
        var i, s;
      ...
      initThree() {
        n.WebGLRenderer
          ? ((n.ColorManagement.enabled = !1),
            ...
            (this.renderer.outputColorSpace = n.LinearSRGBColorSpace),
            (this.renderer.useLegacyLights = !0),
            this.options.canvas
      ...
      resize() {
        this.setSize(),
          ...
          console.log("RESIZE-WAVES", this.width, this.height, this.renderer),
          this.renderer &&
      ...
      isOnScreen() {
        ...
        const t = this.options.canvas
            ? this.options.canvas.height
            : this.el.offsetHeight,
          e = (this.options.canvas || this.el).getBoundingClientRect(),
          i =
            window.pageYOffset ||
            (
    ...
    const a = h.VantaBase;
    let p = "object" == typeof globalThis && globalThis.THREE;
    class l extends a {
      static initClass() {
      ...
      onInit() {
        ...
        this.gg = [];
        const n = [];
        for (t = 0; t <= (this.options.ww || this.ww); t++)
          for (this.gg[t] = [], e = 0; e <= (this.options.hh || this.hh); e++) {
            const i = n.length,
              s = new p.Vector3(
                18 * (t - 0.5 * (this.options.ww || this.ww)),
                (null == (h = 0) && (h = 0),
                null == (r = this.waveNoise) && (r = 1),
                h + Math.random() * (r - h) - 10),
                18 * (0.5 * (this.options.hh || this.hh) - e),
              );
        ...
        o.setFromPoints(n);
        const a = [];
        for (t = 1; t <= (this.options.ww || this.ww); t++)
          for (e = 1; e <= (this.options.hh || this.hh); e++) {
            let s, o;
            const n = this.gg[t][e],
              h = this.gg[t][e - 1],
              r = this.gg[t - 1][e],
        ...
        c.position.set(-100, 250, -100),
          ...
          (this.camera = new p.PerspectiveCamera(
            ...
            (this.options.camera && this.options.camera.far) || 1e4,
          )),
      ...
      onUpdate() {
        let t;
        if (void 0 !== this.options.hue) {
          this.options.hue >= 360
            ? (this.countDown = !0)
            : this.options.hue <= 0 && (this.countDown = !1);
          const t = this.updateTick === this.options.colorCycleSpeed;
          if (
            ((this.updateTick =
              t || void 0 === this.updateTick ? 0 : this.updateTick + 1),
            t)
          ) {
            const t = this.countDown ? --this.options.hue : ++this.options.hue;
            this.plane.material.color.set(
              `hsl(${t}, ${this.options.saturation}%, ${this.options.lightness}%)`,
            );
          }
        }
